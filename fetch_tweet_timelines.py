...
parser.add_argument('--user_mentions_file', default='data/user_tweet_metions.json',
                    help='tab-separated file consisting of [tweet_id, user_id, label, text] tuples.')
                        ...
                        if len(id_list) >= 100:
                            ...
                            if len(data_buffer) >= 1000:
                                for data in data_buffer:
                                    outfile.write(str(data[0]) + '\t' + str(data[1]) + '\t' + str(data[2]) + '\t' + str(
                                        data[3]) + '\n')
                                data_buffer.clear()
